...
<div class="about-section">
    ...
    <div class="content">
       ...
       <div class="title-section">
        ...
        <p class="specialedestra fade-in">L'incontro è avvenuto durante una lezione di progettazione di sistemi web. Il professore assegnò loro un progetto di gruppo: sviluppare un sito web innovativo. La passione comune per la musica elettronica li spinse a collaborare, dando vita a una partnership che avrebbe cambiato le loro vite.</p>
       <div class="title-section">
        <h1>La Visione</h1>
       </div>
       ...
       <div class="title-section">
        ...
        <p class="specialedestra fade-in">Decisero di creare un sito che non solo vendesse strumenti musicali, ma fosse anche una risorsa educativa e una comunità per musicisti. Il loro obiettivo era offrire tastiere, chitarre elettriche, mixer, amplificatori e cuffie, insieme a contenuti di alta qualità come recensioni, tutorial e video dimostrativi.</p>
    </div>
</div>
    ...
    <div class="column">
        <div class="card">
            ...
            <div class="container">
                ...
                <p>Non sai quale strumento sia più adatto alle tue esigenze?</p>
                <p>Ti aiutiamo noi!</p>
            </div>
        </div>
    </div>
    ...
    <div class="column">
        <div class="card">
            ...
            <div class="container">
                ...
                <p>Alta frequenza non è solo vendita, ma è una grande famiglia</p>
